...
public abstract class Car {
    ...
    protected final void stop(){// to make sure no one except child class can accept it
        System.out.println("Press the break to stop "+ make+" "+model);
    }
    protected abstract void start();// to make sure no one except child class can accept it. Method meant to be overridden
